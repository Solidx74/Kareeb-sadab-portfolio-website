...
CS undergraduate at CUET, focused on data science, machine learning, and AI engineering, with a second track in application security from a stint as CISO. I like taking a project from raw data to a deployed API, and I'm comfortable across the full lifecycle: collection, cleaning, EDA, feature engineering, training, evaluation, and deployment.
...
More projects and write-ups live on the [portfolio site](https://ksportfolioweb.vercel.app).

## Experience

### Chief Information Security Officer (CISO)
W3D, Web3 Discord Community Agency · Jun 2025 to Jul 2026

Owned application security across several community-driven Web3 projects, running threat models and vulnerability assessments before anything shipped. Worked with dev teams to bake security into the SDLC. Harold Health passed review, reached token launch, and is now listed on Dexscreener.
